...
* **Virtual Sensor Suite:** Simulated GPS, IMU (AHRS), and 360-degree LiDAR raycasting.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/guiesteves05/TSBphase2_Autonomous_Simulator.git](https://github.com/guiesteves05/TSBphase2_Autonomous_Simulator.git)
...
1. **Start the ROS2 Bridge:**
   Open a terminal, navigate to the project directory, and run the bridge script to start listening for Unreal Engine telemetry:
   ```bash
